...
/**
 *  Tests de los elementos de la vista product-list.
...
public class ProductListTest extends BaseTest{
    ...
    void productsTableTest() {
        ...
        assertEquals("8", (driver.findElement(
        ...
        assertEquals("Botella", (driver.findElement(
        ...
        assertEquals("5", (driver.findElement(
        ...
        assertEquals("WebCam", (driver.findElement(
    ...
    void addProductButtonTest() {
        ...
        button.click();
        //String newURL="http://testing-alansastre.herokuapp.com/products/new";
    ...
    void viewProductTest() {
        ...
        //assertEquals("http://testing-alansastre.herokuapp.com/products/9/view", driver.getCurrentUrl());
    ...
    void seeButtonTest() {
        ...
        seeButton.click();
        String newURL = "http://testing-alansastre.herokuapp.com/products/9/view";
        driver.get(newURL);
    ...
    void editButtonTest() {
        ...
        editButton.click();
        String newURL = "http://testing-alansastre.herokuapp.com/products/9/edit";
        driver.get(newURL);
        String new1Title = driver.getTitle();
