...
class ProductRepositoryTest {
    ...
    class RetrieveTest {
        ...
        @DisplayName("Buscar los productos utilizando un id del fabricante conocido")
        @Test
        ...
        @Test
        void findAllByManufacturerIdIsNull() {
        ...
        @DisplayName("Buscar los productos utilizando el id del fabricante: conocido o nulo")
        @Test
        void findAllByManufacturerIdOrManufacturerIdIsNull() {
            List<Product> productsAdidas = repository.findAllByManufacturerId(1L);
            List<Product> productsNike = repository.findAllByManufacturerId(3L);
            List<Product> productsNull = repository.findAllByManufacturerId(null);
            assertAll(
